...
<linearGradient id="Q4Gradient" x1="0%" y1="0%" x2="100%" y2="0%">
  ...
  <g>
    ...
    <circle filter="url(#dropShadow)" cx="1210" cy="150" r="30" stroke="white" fill="#FF00FF" stroke-width="5" />
    <rect x="922" y="116" width="240" height="72" stroke-width="5" stroke="#FF00FF" fill="var(--background-primary)" rx="10" ry="10" />
    <text filter="url(#dropShadow)" x="1144" y="170" fill="white" font-size="60" text-anchor="end">29-Apr</text>
  </g>
</svg>
...
***
### Journal
Today I managed to apply for work experience at the Francis Crick institute: I will update this to show in [[Finding Work Experience]] in due course, I am very hopeful that this goes well, as I am not sure what to fall back on following the rejection from Arm. I am going to continue to prioritise stuff around IT, CS, UX, Robotics, Physics and Engineering.  

I have a science test in a few days on [[C4 Chemistry]]: A topic which I am not confident on, I will need to do rigorous revision to perform even adequately. 

Today was relatively slow: 

- Double English **(need to catch up on great expectations**
- Personal Dev
- Geography: **Must Complete 9 marker**
- Phys Ed
- Computer Science: **Complete both of the CS paper twos**
