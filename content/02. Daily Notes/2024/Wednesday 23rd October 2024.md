...
<linearGradient id="Q4Gradient" x1="0%" y1="0%" x2="100%" y2="0%">
  ...
  <g>
    ...
    <circle filter="url(#dropShadow)" cx="3050" cy="150" r="30" stroke="white" fill="#FF00FF" stroke-width="5" />
    <rect x="2762" y="116" width="240" height="72" stroke-width="5" stroke="#FF00FF" fill="var(--background-primary)" rx="10" ry="10" />
    <text filter="url(#dropShadow)" x="2984" y="170" fill="white" font-size="60" text-anchor="end">23-Oct</text>
  </g>
</svg>
...
***
### Journal
>[!tip] Restarting Daily Notes: 
>I have abandoned daily notes as of late, simply because they weren’t a proper habit: but it is time I come back to them, especially considering the advanced framework I have already established. 

**Schools Updates:**
- Core subject mocks are over, I have recieved results for History, whilst in relativity to those in my class I performed well. I do think that I could’ve gotten a lot better had I made a better effort to properly cater my mark scheme to the specification 
	- **History: 18/24**
- Along with this, I have switched from Atomoxetine to Lisdexamfetamine. **To note:**
	-  Improved in focus in some ways, however inconsistent on said improvement 
	- Less anxious than I was on previous medication 
	- I run into lethargy and feel under-stimulated towards the end of the week: Thurs, Fri on some weeks. Perhaps because I eat the most on the weekend and I am furthest from the weekend at that point 
