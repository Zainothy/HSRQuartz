...
Makes the wearer's first ultimate and every other ultimate after that regenerate a skill point and gives the ally Sparkle uses her skill on 30% damage bonus buff for 1 turn. The ERR buff isn't too useful.
### 3. **Dance! Dance! Dance!** (Gacha 4★  Light Cone)

Advances forward all allies' turns by 24% at superimposition 5 when the wearer uses their ultimate. Due to the fact that Sparkle has no energy issues whatsoever, this is a very easy light cone to use on her. However, if you don't have it at a high superimposition then it may not even be worth building around to make use of it.
### 4. **Past and Future S5** (Free 4★ Light Cone)

Gives the ally Sparkle uses her skill on 32% damage bonus buff for 1 turn.
...
- **183.4**: with 4-piece Eagle of Twilight Line

- **184**: with S5 Dance! Dance! Dance! (DDD)

- **173.4**: with Eagle and Ruan Mei
...
2. **Eidolon 6** The Crit. DMG buff provided by the skill additionally increases by 30% of Sparkle's Crit. DMG and the skill's Crit. DMG buff now extends to all allies with 'Cipher', making it a team-wide buff pretty much permanently. A huge increase for dual dps and triple dps teams, but not so much for hypercarry.
